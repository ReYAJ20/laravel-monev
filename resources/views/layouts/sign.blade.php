                        ...
                        <div class="col-lg-6 d-none d-lg-block" style="background-color: whitesmoke;">
                            <div class="p-5 d-flex justify-content-md-center align-items-center vh-100">
                                <div class="text-center">
                                    ...
                                    <h2 class="h6 text-gray-900 mb-4">Untuk tetap mendapatkan informasi mengenai PROKER HMPSSI, silahkan masuk dengan akun anda</h2>
                            ...
                            <div class="p-5">
                                <div class="text-center mt-3">
                                    <div class="text-center">
                                        ...
                                        <h2 class="h6 font-weight-normal text-gray-900 mb-4">Daftarkan dirimu untuk mendapatkan informasi mengenai PROKER HMPSSI</h2>
                                    </div>
                                </div>
                                <form role="form" method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label font-weight-bold">Pilih Divisi</label>
                                        <div class="input-group">
                                            <div class="input-group">
